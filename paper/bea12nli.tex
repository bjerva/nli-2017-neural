...
NLI has been the subject of several shared tasks in recent years \citep{nli2013}.
In recent years, NLI has also turned to including non-English language \citep{multilingual-nli}.
For an overview, see \citet{malmasi2016}.
Recently, speech transcripts and audio features have also been used \cite{compare2016}.
Although these aspects are combined in the NLI 2017 shared task, with both written and spoken responses available, we only utilise the written responses in this work.
