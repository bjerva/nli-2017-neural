...
Neural networks constitute one of the most popular methods in natural language processing these days, but appear not to have been previously used for NLI.
...
For one, spelling errors are quite prevalent in learners\' written production.
